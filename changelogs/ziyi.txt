...
- Updater: Use Compose system update icon (`b93ded1`, rwicept)
- Updater: Migrate import progress dialog to Jetpack Compose (`144ccf8`, rwicept)
...
- sdm: get around client compositioning for FOD pressed layer (`6e9e06107`, Demon Singur)

## `packages/apps/Settings`
- BlurSwitchPreference: Default from blur_disabled_by_default sysprop (`5b40611e40a`, Ashwin Devi Srinivasan)

## `vendor/qcom/opensource/vibrator`
- vibratorOL: Enforce min/max timeout for LDO vibrator motor (`7ec5149`, kleidione Freitas)
